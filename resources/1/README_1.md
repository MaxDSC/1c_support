...
### <a name="4"></a>4. Настройка службы сервера и группы пользователей 1С:Предприятие
...
### <a name="7"></a>7. Создание роли разработчика конфигурации и обычного пользователя
...
### <a name="8"></a>8. Подключение к серверу с клиента
